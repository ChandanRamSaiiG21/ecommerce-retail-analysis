...
| I2 | 112,650 items for 99,441 orders — multi-item orders | Low | Expected; max 21 items per order |
...
| # | Issue | Severity | Fix (Day 2) |
|---|-------|----------|-------------|
| P1 | 103,886 rows for 99,441 orders — split payments | Medium | Sum by order_id for revenue calc |
...
- Zero orphaned foreign keys across all tables — referential integrity is clean
- Zero nulls in orders.order_id, customer_id, order_status — core identifiers intact  
- payment_installments up to 24 — expected in Brazilian credit market
